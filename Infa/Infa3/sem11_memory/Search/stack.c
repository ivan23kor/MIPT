...
{
    assert (stack1->data = (int *) malloc (INIT_SIZE * sizeof (int)));
    stack1->top = 0;
...
int stack_push (struct stack *stack1, int x)
{
    if (stack1->top == stack1->max_size)
    {
        ...
        assert (stack1->data = (int *)realloc (stack1->data, ((int)(stack1->max_size)) * sizeof (int)));
    }
...
int stack_pop (struct stack *stack1)
{
    ...
    if (((stack1->top) < ((stack1->max_size) / 2.0)) && (stack1->max_size > (INIT_SIZE - 1))) //if more than a half of stack memory is not used
    {
        ...
        stack1->data = (int *)realloc (stack1->data, (int)(stack1->max_size) * sizeof (int));
    }
